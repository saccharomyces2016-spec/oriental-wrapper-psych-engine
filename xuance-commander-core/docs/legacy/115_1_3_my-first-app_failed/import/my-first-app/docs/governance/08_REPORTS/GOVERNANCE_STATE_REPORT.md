...
**詳細資料**: 見 `artifacts/governance_runs/artifacts/governance_runs/_governance/state_snapshot/keep_final_detected.json`
...
**詳細資料**: 見 `artifacts/governance_runs/artifacts/governance_runs/_governance/state_snapshot/legacy_candidates_classified.json`
...
**詳細地圖**: 見 `artifacts/governance_runs/artifacts/governance_runs/_governance/state_snapshot/import_graph_summary.tsv`
...
根據 `artifacts/governance_runs/artifacts/governance_runs/_governance/cleanup_phase2/delete_paths.txt`：
...
**詳細計畫**: 見 `artifacts/governance_runs/artifacts/governance_runs/_governance/state_snapshot/delete_plan_phase3.txt`
...
**詳細計畫**: 見 `artifacts/governance_runs/artifacts/governance_runs/_governance/state_snapshot/delete_plan_phase4.txt`
...
**機器可讀檔位置**: `artifacts/governance_runs/artifacts/governance_runs/_governance/state_snapshot/`
