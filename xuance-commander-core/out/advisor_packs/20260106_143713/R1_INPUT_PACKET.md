...
---
# ROLE SECTION: R1 (Question Blueprint)

## Deliverable
- Provide >=3 question blueprints (structure, ratio, intent per segment, differentiation mechanism)
- Must produce stable 3–5 states segmentation
- CN/EN must feel native (not literal translation)

## Forbidden
- Any psych/science/engineering terminology in user-facing phrasing
- Diagnostic tone
...
---
## FILE: docs/gem/briefs/P0-2 R1 blueprint brief
