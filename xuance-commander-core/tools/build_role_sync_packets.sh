...
COMMON_FILES=(
  ...
  "$XC_ROOT/docs/governance/TEXT_ONLY_EXECUTION_RULES.md"
  ...
  "$XC_ROOT/docs/research/life_cycle_0_100_integrated_research_note.zh.md"
  "$XC_ROOT/docs/gem/briefs/BRIEF_lessons_and_constraints.zh.md"
